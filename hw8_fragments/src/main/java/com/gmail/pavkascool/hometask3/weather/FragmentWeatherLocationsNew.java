...
public class FragmentWeatherLocationsNew extends Fragment implements View.OnClickListener {
    ...
    public static FragmentWeatherLocationsNew newInstance() {
        FragmentWeatherLocationsNew fragment = new FragmentWeatherLocationsNew();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_weather_locations_new, container, false);
    ...
    private class LocAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            String s = FragmentWeatherLocationsNew.this.locations.get(position);
            locViewHolder.local.setText(s);
        }

        @Override
        public int getItemCount() {
            if (FragmentWeatherLocationsNew.this.locations != null) {
                return FragmentWeatherLocationsNew.this.locations.size();
            }
            return 0;
        }
    }
    ...
    private class LocViewHolder extends RecyclerView.ViewHolder {
        ...
        public LocViewHolder(@NonNull View itemView) {
            ...
            local.setOnClickListener(FragmentWeatherLocationsNew.this);
            remove.setOnClickListener(FragmentWeatherLocationsNew.this);
